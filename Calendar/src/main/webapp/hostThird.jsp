																...
																<div class="_az0uecb">
																	<div class="_y9ev9r">
																		<select id="bedroom-select" name="bedrooms"
																			class="_10p0m0gl"><option selected=""
																			...
																			<option value="21">침실 21개</option>
																			<option value="22">침실 22개</option>
																			<option value="23">침실 23개</option>
																			<option value="24">침실 24개</option>
																			<option value="25">침실 25개</option>
																			<option value="26">침실 26개</option>
																			<option value="27">침실 27개</option>
																			<option value="28">침실 28개</option>
																			<option value="29">침실 29개</option>
																			<option value="30">침실 30개</option>
																			<option value="31">침실 31개</option>
																			<option value="32">침실 32개</option>
																			<option value="33">침실 33개</option>
																			<option value="34">침실 34개</option>
																			<option value="35">침실 35개</option>
																			<option value="36">침실 36개</option>
																			<option value="37">침실 37개</option>
																			<option value="38">침실 38개</option>
																			<option value="39">침실 39개</option>
																			<option value="40">침실 40개</option>
																			<option value="41">침실 41개</option>
																			<option value="42">침실 42개</option>
																			<option value="43">침실 43개</option>
																			<option value="44">침실 44개</option>
																			<option value="45">침실 45개</option>
																			<option value="46">침실 46개</option>
																			<option value="47">침실 47개</option>
																			<option value="48">침실 48개</option>
																			<option value="49">침실 49개</option>
																			<option value="50">침실 50개</option></select>
																	</div>
										...
										<div>
											...
											<div class="page-container-full">
												<div id="room_0"
													...
													<div class="col-sm-6 no-padding-h">
														<div class="jumbo-font-size text-normal">
															<span>공용 공간</span>
														</div>
														<div class="text-muted">
															<span>침대 0개</span>
														</div>
														<div class="beddetail-item-bedtype-summary">
															<div class="text-muted"></div>
														</div>
													</div>
													<div>
														<div class="col-sm-6 no-padding-h text-right">
															<button class="btn btn-large text-jumbo-normal">
																<span>침대 추가하기</span>
															</button>
														</div>
														<div class="col-sm-12 no-padding-h"></div>
													</div>
												</div>
											</div>
										</div>
												...
												<div class="row no-margin-padding__sm">
													<div
														...
														<div class="_1dcqn1vg"
															...
															<div class="_107ja4p">
																<button type="button" disabled="" class="_5rte3y6"
